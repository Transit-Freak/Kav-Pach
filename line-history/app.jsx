            ...
            const evRow = (c, one) => {
              ...
              return (
                ...
                <div className={"srow" + (one ? "" : " sub") + (c.la != null ? " clk" : "")}
                  ...
                  {/* הארכיון מתחיל ב-2017, ומגיעים מ-2012 מקדים אותו בחמש
                      שנים. ב"תחנה חדשה" זו לא הערת רקע אלא תיקון: התחנה
                      חזרה לרישום, לא נבנתה. */}
                  {c.m12 && <span className="m12flag" title={c.k === "new"
                    ? "התחנה כבר הופיעה במסלול של קו במאגר מגיעים מ-2012, ולכן אין מדובר בתחנה שנבנתה עכשיו אלא בחזרה לרישום הארצי"
                    : "התחנה מופיעה במסלול של קו במאגר מגיעים מ-2012 — חמש שנים לפני תחילת הארכיון"}>
                    {c.k === "new" ? "הייתה כבר ב-2012" : "מתועדת ב-2012"}</span>}
                  <span className="meta">
...
const SOURCES = [
  ...
  { t: "ארכיון TransitFeeds / OpenMobilityData", d: "16.03.2017 – 14.01.2022",
    b: "799 צילומים של הפיד הארצי. 16.03.2017 הוא הצילום הישן ביותר שקיים שם — בדקנו כל יום משנת 2013 ואילך ואין מוקדם ממנו. משם מגיעה כל ההיסטוריה שלפני 2022, בקווים ובתחנות כאחד." },
