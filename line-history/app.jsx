              ...
              return (
                ...
                <div className={"srow" + (one ? "" : " sub") + (c.la != null ? " clk" : "")}
                  ...
                  <span className="meta">
                    ...
                    {/* מה השינוי בפועל (בקשת שלמה): שם היעד שעל השלט השתנה —
                        ישן ← חדש, בלי קווים (כשהשם משתנה הוא משתנה לכולם) */}
                    {c.k === "pubdest" && (c.st === "ren"
                      ? <> · שם היעד שעל שלט האוטובוס שוּנה: <s>{c.oh}</s> ← <b>{c.nh}</b></>
                      : <> · {c.st === "in" ? "הפכה לתחנת היעד שעל שלט האוטובוס" : "אינה עוד תחנת היעד שעל השלט"}{c.ln && c.ln.length ? <> · קו {c.ln.slice(0, 8).join(", ")}</> : null}</>)}
...
const SRC_LABEL = {
  tf: "מקור: ארכיון TransitFeeds / OpenMobilityData — צילומי הפיד הארצי של משרד התחבורה (הארכיון מכסה 03.2017–01.2022; זה טווח המקור, לא טווח הקו)",
