import{dt as e,et as t,ft as n,gt as r,pt as i}from"./utils-BH7kdYtO.js";import{i as a}from"./useThemeProps-_q0DsjBv.js";import{Rt as o,n as s,t as c,zt as l}from"./PageContainer-B_OMSoMB.js";import{n as u}from"./ThemeContext-DpDBnBRI.js";import{l as d,n as f}from"./IconButton-CPhkSFy4.js";import{n as p}from"./globalState-CnvLc8xZ.js";import{t as m}from"./Typography-G8qcp5W3.js";import{t as h}from"./TimeSelector-6fc981io.js";import{n as g,t as _}from"./styled-components.browser.esm-Fyl9wwGe.js";import{r as v}from"./dist-BdefjVmq.js";import{Cn as y,Fn as b,In as x,Nn as S,Rn as ee,S as te,_ as ne,h as re,kn as C,m as ie,v as ae,vn as oe,x as se}from"./index-B8bK24t4.js";import{t as ce}from"./es-CJi0WW0E.js";import{t as le}from"./StopSelector-DxuPeMhj.js";var ue=r(i(),1),de=e(),w=ce();function fe(e,t){let n=(0,w.computeDestinationPoint)(e,t,0),r=(0,w.computeDestinationPoint)(e,t,180),i=(0,w.computeDestinationPoint)(e,t,90);return{lowerBound:{longitude:(0,w.computeDestinationPoint)(e,t,270).longitude,latitude:r.latitude},upperBound:{longitude:i.longitude,latitude:n.latitude}}}function pe(e,t){return(0,w.findNearest)(e,t)}var me=500;async function he(e,t,n){let r=fe(t.location,me),i=(await d.siriVehicleLocationsListGet({limit:1024,siriRoutesLineRef:e.lineRef.toString(),recordedAtTimeFrom:l(n).subtract(4,`hour`).toDate(),recordedAtTimeTo:l(n).add(4,`hour`).toDate(),latGreaterOrEqual:r.lowerBound.latitude,latLowerOrEqual:r.upperBound.latitude,lonGreaterOrEqual:r.lowerBound.longitude,lonLowerOrEqual:r.upperBound.longitude,orderBy:`distance_from_siri_ride_stop_meters desc`})).reduce((e,t)=>(t.siriRideId&&(e[t.siriRideId.toString()]||=[]).push({...t,longitude:t.lon||0,latitude:t.lat||0}),e),{}),a=Object.values(i).map(e=>pe(t.location,e)),o=e=>Math.abs(n.diff(l(e.recordedAtTime),`second`));return a.sort((e,t)=>o(e)-o(t)).sort((e,t)=>e.recordedAtTime.getTime()-t.recordedAtTime.getTime())}var T=`var(--timeline-neutral, #7393B3)`,E=`#1890ff`,D=`#eb2f96`,O=function(e){return e[e.BOUNDARY=0]=`BOUNDARY`,e[e.GTFS=1]=`GTFS`,e[e.SIRI=2]=`SIRI`,e}({}),k={0:T,1:E,2:D},ge={0:null,1:`timestamp_gtfs`,2:`timestamp_siri`},A=g.div`
  height: ${8}px;
  width: ${8}px;
  border-radius: 50%;
