...
kids.push(Note('ההליכה נמדדת בניתוב אמיתי על רשת OpenStreetMap במהירות 5 קמ"ש, בפרופיל שמתיר כבישי שירות פרטיים ורמפות של כבישים ראשיים, כי שם עוברים העובדים בפועל. תחנה במרחק של יותר מ-15 דקות הליכה אינה נספרת כלל, והקו החזק של האזור שווה לכל היותר את מדרגת ההליכה של התחנה שבה הוא עוצר.'));
