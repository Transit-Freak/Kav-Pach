...
#         infra = תשתית (נמל, זיקוק, תעופה...) · mine = כרייה וחציבה
#
...
_RULES = [
    ('exclude', r'^שכונת |טיהור שפכים|מט"ש|מט״ש|תחנת שאיבה|מאגר מים|כפר הנוער'),
    ('mine',    r'מחצב|מכרות|כריי|פוספטים|מפעלי ים המלח'),
